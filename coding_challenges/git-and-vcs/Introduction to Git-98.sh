...
/home/dq/random_numbers$ echo ' print("10")' 1>> script.py
...
/home/dq/random_numbers$ git config --global user.name "Fuji"
...
/home/dq/random_numbers$ git commit -m "Added random calc."
