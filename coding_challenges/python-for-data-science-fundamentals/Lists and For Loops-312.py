...
total = sum([ratings_1, ratings_2, ratings_3])
average = total/3
...
total_rating = sum([rating_1, rating_2, rating_3])
...
total_rating = sum([fb_rating_data[-1], insta_rating_data[-1], pandora_rating_data[-1]]) 
...
total = sum([app_data_set[0][-1], app_data_set[1][-1], app_data_set[2][-1], app_data_set[3][-1], app_data_set[4][-1]])
