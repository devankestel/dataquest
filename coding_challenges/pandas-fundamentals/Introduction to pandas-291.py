...
middle_companies_all_rows = f500['Tata Motors':'Nationwide']
middle_companies = middle_companies_all_rows.loc[:, 'rank':'country']
...
big_movers_rows = f500.loc[['Aviva', 'HP', 'JD.com', 'BHP Billiton']]
big_movers = big_movers_rows[['rank', 'previous_rank']]

bottom_companies_rows = f500['National Grid':'AutoNation']
bottom_companies = bottom_companies_rows[['rank', 'sector', 'country']]